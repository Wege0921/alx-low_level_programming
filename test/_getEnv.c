...
/**
 * get_environ - Retrieves and returns a copy of the environment variables.
 * @info: Structure containing shell-related information.
 *
 * Return: A copy of the environment variables as an array of strings.
 */
...
int _unsetenv(info_t *info, char *var)
{
	...
	return (info->env_changed);/*return the var is successfully deleted or not*/
}
